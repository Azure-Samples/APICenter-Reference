...
namespace WebApp.ApiClients.Store.Inventory {
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="InventoryRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="InventoryGetResponse"/></returns>
...
#nullable restore
        ...
        /// Returns a map of status codes to quantities
        /// </summary>
        /// <returns>A <see cref="InventoryResponse"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="InventoryRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
